...
public class Map {
    ...
    public void buildWorld() {
        ...
        room2.addItem(new MeleeWeapon("A big strange {bone}", "Bone", 2, 5, 0,ItemRarity.COMMON));
        room2.addEnemy(new Enemy("The big mutant [rat]", "rat", 10,
                new MeleeWeapon("Rat {claws}", "claws", 3, 5, 5,ItemRarity.COMMON),
        ...
        room3.addEnemy(new Enemy("Sandwich-making [troll]", "troll", 40,
                new MeleeWeapon("Hobbit 'n' Cheese {slicer}", "slicer",12 , 4, 3,ItemRarity.COMMON)));
        ...
        room4.addItem((new MeleeWeapon("Two-handed[sword]", "sword", 10, 10, 4,ItemRarity.COMMON)));
        ...
        room4.addEnemy(new Enemy("Old sleeping Fisher[man]","man",5,
                new MeleeWeapon("Old Fishing {pole}", "pole", 5, 1,0,ItemRarity.COMMON),
        ...
        treasureRoom.addEnemy(new Enemy("Treasure [hoarder]", "hoarder", 1,
                new MeleeWeapon("{Sparrow}, Golden scimitar of the Pirate King", "Sparrow", 40, 15, 5,ItemRarity.LEGENDARY)));
        ...
        room6.addEnemy(new Enemy("Lord [Lars]", "Lars",20,
                new MeleeWeapon("White Support {Cane}","cane",10,10,10,ItemRarity.RARE),
                new Consumable("Health [Potion]", "potion",20,ItemRarity.COMMON)));
        ...
        room7.addEnemy(new Enemy("Green [Serpent]", "serpent", 30,
                new MeleeWeapon("Scaled {tail}", "tail", 3, 8, 5,ItemRarity.COMMON)));
        room7.addEnemy(new Enemy("Jake the [Snake]", "snake", 30,
                new MeleeWeapon("Poisoned {fangs}", "fangs", 8, 6, 1,ItemRarity.COMMON)));
        ...
        lairOfTyson.addEnemy(new Enemy("Mike [Tyson], Destroyer of Ears", "Tyson", 125,
                new MeleeWeapon("{Earbiter}", "Earbiter", 20,100,5,ItemRarity.EPIC),
        ...
        room8.addEnemy(new Enemy("[Gorlock] the Destroyer", "Gorlock", 80,
                new MeleeWeapon("Sharp diamond {axe}", "axe", 10, 15, 8,ItemRarity.RARE)));
        room8.addEnemy(new Enemy("Red [spider]","spider", 5,
                new MeleeWeapon("Spider [leg]","leg", 5, 5,0,ItemRarity.UNCOMMON)));
        ...
        room9.addEnemy(new Enemy("[Goblin] Raver #1", "goblin", 15,
                new MeleeWeapon("{Dagger}","dagger",5,5,5,ItemRarity.COMMON),
                new Consumable("Health [Potion]", "potion",20,ItemRarity.COMMON)));
        ...
        room9.addItem(new MeleeWeapon("Faintly glowing [sticks]", "sticks", 1, 1, 1,ItemRarity.UNCOMMON));
